...
## 制作书源
- AI编码：推荐使用WorkBuddy有免费额度完全用不完，可以将本仓库地址+想要做成书源的网站地址复制给WorkBuddy，让AI参考已有书源编写即可。
- 如果不想要AI，也不会古法编码，建议使用书源教程中的书源或者使用[`开源阅读`](https://github.com/search?q=%E9%98%85%E8%AF%BB%E4%B9%A6%E6%BA%90&type=repositories)的书源。
#### 书源接口介绍（`Python`）
```python
